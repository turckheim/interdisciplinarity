...
print(system.time({
  ...
  for (institution in institutions) {
    ...
    SELECT tmp_wos_valides.CAT_COD_CITANT, tmp_wos_valides.CLEUT_CITANT, tmp_wos_valides.CAT_COD_CITE, sum(1/nbCat) AS count
    FROM tmp_wos_valides, tmp_wos_nbcat
    WHERE tmp_wos_valides.CLEUT_CITANT = tmp_wos_nbcat.CLEUT_CITANT
    AND tmp_wos_valides.CLEUT_CITE = tmp_wos_nbcat.CLEUT_CITE
    AND tmp_wos_valides.CAT_COD_CITANT = tmp_wos_nbcat.CAT_COD_CITANT
    GROUP BY (tmp_wos_valides.CAT_COD_CITANT, tmp_wos_valides.CLEUT_CITANT, tmp_wos_valides.CAT_COD_CITE)
    ORDER BY tmp_wos_valides.CAT_COD_CITANT, tmp_wos_valides.CLEUT_CITANT, tmp_wos_valides.CAT_COD_CITE
    "))
